    ...
    return (
        <>
            ...
            {(cardsVariant === 'all' || cardsVariant === 'wrestling') && <div>
                ...
                <Cards cardsArray={cardsWrestling} variant={'videos'}/>
            </div> }
            {(cardsVariant === 'all' || cardsVariant === 'mma') && <div>
                ...
                <Cards cardsArray={cardsMMA} variant={'videos'}/>
            </div>}
            {(cardsVariant === 'all' || cardsVariant === 'boxing') && <div>
                ...
                <Cards cardsArray={cardsBoxing} variant={'videos'}/>
            </div>}
            {(cardsVariant === 'all' || cardsVariant === 'mix') && <div>
                ...
                <Cards cardsArray={cardsMix} variant={'videos'}/>
            </div>}
        </>
