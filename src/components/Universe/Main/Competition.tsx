...
import {IrinaVsTais2008} from "../../../localdata/competition/Archive/IrinaVsTais2008"
import {BeachMix2010} from "../../../localdata/competition/Archive/BeachMix2010"
        ...
        <div className={sC.compArticlesVideoGirl}>
           <h3>{yearsConverter(years)}</h3>
            <Routes>
                ...
                <Route path='IrinaVsTais2009' element={<IrinaVsTais2008/>}></Route>
                <Route path='beach-mix-2010' element={<BeachMix2010/>}></Route>
