...
export const Maslenitsa2016 = () => {
    return (
        <>
            <NavLink to={'/universeeng/compArticles/2015-2017/maslenitsa-2016'}><h3>Female power competitions for the Maslenitsa
            ...
            <NavLink to={'/universeeng/compArticles/2015-2017/maslenitsa-2016'}>
