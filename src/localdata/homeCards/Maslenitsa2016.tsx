...
export const Maslenitsa2016 = () => {
    return (
        <>
            <NavLink to={'/universe/compArticles/2015-2017/maslenitsa-2016'}><h3>Female power competitions for the Maslenitsa
            ...
            <NavLink to={'/universe/compArticles/2015-2017/maslenitsa-2016'}>
