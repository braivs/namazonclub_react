...
export function SumbissionGrappling() {
  return (
    <>
      <NavLink to={'/universeeng/articles/submission'}><h3>Submission Grappling (Wrestling) as Single Combat</h3></NavLink>
      <img src={sg} alt=""/>
      <p><b>Submission grappling</b> (Submission wrestling) is a non-striking hybrid style formed of wrestling, jiu
        ...
        <NavLink to={'/universeeng/articles/submission'}><button type="button">Read more...</button></NavLink>
    </>
  );
}