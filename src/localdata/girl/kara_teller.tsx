...
export const KaraTeller = () => {
    ...
    return (
        <>
            ...
            />
            <p><b>Kara Teller</b> (the Vityaz Club, Moscow) is a very tender, feminine girl in daily life and a tough,
                brave,
                stubborn fighter on a wrestling mat and in a ring. She is specialized in karate, sambo, MMA and also in
                hand-to-hand combat named street fighting. Being 5'7" tall and weighing 121 lb, she is afraid of nobody
                and
                fights valiantly against opponents who are heavier and physically stronger than her. At the Namazon
                Club, she
            ...
            <p>
                ...
                First two rounds <NavLink to="/universe/girl/2012_2013/elena-vasileva2013">Elena</NavLink> (St.
                Petersburg, 5’6” / 132 lb) totally
            ...
            <ButtonGallery
                ...
                buttonName={buttonText}
            />
            <p>In the third round it became clear that Elena was getting tired. Kara managed to get control of the
                fight, due
            ...
            <p>
                Quite obviously, <b>Svetlana Solovyova</b> (St. Petersburg; 5’7” / 124 lb) was superior to Kara in
                physical
                power. For example, dynamometric measures of her hand grip strength were 56.3 kg (124 lb), which was
                more than
                her own weight! But on Kara’s side was her fighting experience that made up for the lack of her strength
                during
                their fight.<br/>
                In the beginning, when the girls were exchanging blows and kicks in stand up, Svetlana was still able to
                somehow
                withstand Kara’s attacks, but when the fight was brought to the ground, Kara’s advantage became more
                evident.
            </p>
            <ButtonGallery
                index={index4}
            ...
            <p>
                ...
                Balina</NavLink> (the female
                self-defense Club "Panther", St. Petersburg, 5’4” / 124 lb). While Darya had pretty good kick-boxing
                skills, she
                didn’t feel so confident in wrestling (the consequent effect of her combat training with an emphasis on
                self-defense). The fight format was three four minute rounds with a rest period of one minute between
                them. But
                it took Kara only two rounds to gain a victory. The first round was fought in stand up. Kara was better
                with her
                striking. In the second round the fight came to the ground, where Kara again took advantage of Darya and
                finished her off with a choke (the way of finishing an opponent off that has already become Kara’s
                beloved
                tradition).
            </p>
            <ButtonGallery
            ...
            />
            <p>
                The fight format was three four minute rounds with a rest period of one minute between them. But it took
                Kara
                only two rounds to gain a victory.<br/>
                The first round was fought in stand up. Kara was better with her striking. In the second round the fight
                came to
                the ground, where Kara again took advantage of Darya and finished her off with a choke (the way of
                finishing an
            ...
            <p>
                The girls had two fights with each other. The first one was a short MMA fight that lasted a little more
                than a
                minute. After having finished it, they had decided to test their strengths in the second one. This time
                the
            ...
            />
            <p>
                As the opponents were in about the same weight class, their contest was interesting and intriguing.
                Svetlana
                (St. Petersburg, 5’7” / 124 lb) was physically more powerful and spent the majority of the fight on top
                of Kara,
                while Kara, being on her back, used a head scissors in the defense, struggling to get control of
                Svetlana’s arm
                from the bottom position, trying to apply a painful submission hold. However, the time went on and
                nobody seemed
                to be able to earn the victory. Svetlana showed an evident lack of wrestling skill, while Kara wasn’t
                strong
                enough to successfully counterattack. Eventually, the girls got tired, especially Svetlana, and the
                fight was
