...
export const Tais2011 = () => {
  ...
  return (
    <>
      ...
      <p>
        <b>Tais</b> (5'7" / 130 lb) is a many-time winner of the submission grappling championships at the Namazon Club. She is also regarded as the best MMA fighter at our club.
      </p>
      <ButtonGallery
        index={index}
