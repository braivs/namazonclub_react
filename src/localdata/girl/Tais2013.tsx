...
export const Tais2013 = () => {
    ...
    return (
        <>
            ...
            />
            <p>
                <b>Tais</b> (5’7” / 130 lb) is a skilled and strong woman who is specialized in various combative
                sports. She
                competes successfully in Submission Grappling and MMA competitions. She has a beautiful, flexible body
                and a
                character of a dominant fighter. But, as a woman in daily life out of gym, Tais is warm, open and
                approachable.
                She's a very pleasant and comfortable person to be with. If you’ve ever met her you would never think
                that this
                charming, lovely lady could be a formidable opponent for you on a mat. You’d hardly believe, looking at
                her,
                that she’d be able to beat you up without getting in trouble, or pin you down helplessly, or squeeze you
                senseless between her beautiful, powerful thighs. However, she’s really very good in doing all these
                things!
            </p>
            ...
            <p>
                ...
                <NavLink to="/universe/girl/2012_2013/elena-vasileva2013"> Lena</NavLink> (5'6" / 132 lb) already in the
                first
                round.
            </p>
            <ButtonGallery
                ...
                buttonName={buttonText}
            />
            <p>After having mounted her opponent, Tais could freely deliver punches to Kara’s head from the top
                position, but
            ...
            <p>
                During 2012 Tais has had three fights with <NavLink to="/universe/girl/2012_2013/kara-teller"> Kara
                Teller</NavLink> (5'7" / 119
                lb). Two of
                them Tais won with the victory by fall. In the third fight she was disqualified for arguing with the
                referee,
                and Kara was declared a winner.<br/>
                The photo album below shows some pics of the second fight between Tais and Kara. In that fight Tais
                destroyed
            ...
            <ButtonGallery
                ...
                buttonName={buttonText}
            />
            <p>Note that unlike in their first match, Kara managed to offer good resistance, and even counterattack a
                couple
                of times, fighting furiously, but the fight was too difficult and the chances were not in her favor at
                all.</p>
            <h4><u>Tais in Submission Grappling fights</u></h4>
            <p>
                Tais has won all the submission grappling tournaments organized by the Namazon Club in 2008–2011. As a
                wrestler
                she was second to none, both on a mat and on sand beaches.<br/>
                Besides, Tais won many individual wrestling fights against particularly strong opponents. For example,
                she
                defeated such well-known Ukrainian bodybuilders as <b>Irina Dergacheva</b> (Izida) and <b>Anna
                Mihailenko</b>,
                bringing them to submission, and she more than once beat <b>Alesya Veresova</b> who had been a multiple
                champion
                of Byelorussia in arm wrestling and is recently a freestyle wrestling coach.
            </p>
            <p>In <b>2012</b>, in a competitive submission fight, Tais overpowered <b>Varvara Akulova</b> (5'9" / 165
                lb) who
                during her early years had been twice recognized by the Guinness Book of Records as the strongest girl
                in the
            ...
            <p>
                ...
                to="/universe/girl/2012_2013/elena-vasileva2013"> Elena Vasilyeva</NavLink> (5'7" / 157 lb), who had
                been away
                ...
                It was a hard fought and fairly even match, with submissions coming from both sides. And after more than
                20
                minutes of struggling, Lena finally defeated her more experienced opponent. Thus, Tais lost the
                wrestling match
            ...
            <p>
                ...
                Tais’s
                fights 2012-2013 – MМА fights (Videos 9, 17 and 18), submission grappling fights (Videos 19, 29, 33 and
                35) and
