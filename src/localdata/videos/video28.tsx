...
import mainImg from 'src/img/videos/main/28main.jpg'
import {ButtonGallery} from "../../common/common"

const images = require.context('src/img/videos/28/tais-alexander', false)
const images2 = require.context('src/img/videos/28/tais-villian', false)
