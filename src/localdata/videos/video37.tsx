...
import mainImg from 'src/img/videos/37/2/22.jpg'

const images = require.context('src/img/videos/37/1', false)
const images2 = require.context('src/img/videos/37/2', false)
...
export const Video37 = () => {
    ...
    return (
        <div className={sC.compArticlesVideos}>
            ...
            <Button variant="primary" onClick={() => setOpen2(!open2)}>Daria and Victoria SCREENSHOTS</Button>
            <Collapse in={open2}>
